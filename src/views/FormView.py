...
class FormView(sc):
    def __init__(self):
        ...
        self.start_date = self.dateInput((0, 1))
        self.label("Data Fim:", (0, 2))
        self.end_date = self.dateInput((0, 3))
        self.label("Formato de exportação:", (1, 1), colspan=2, sticky="e")
        self.exportTo = self.combobox([".csv", ".json"], (1, 3))
        self.button("Enviar", self.generateReport, (2, 1), colspan=2)
